...
public class ApiAsyncCallerFragment4 extends Fragment {
    ...
    public static ApiAsyncCallerFragment4 getInstance(){
        ApiAsyncCallerFragment4 vFragment = new ApiAsyncCallerFragment4();
        return vFragment;
    }
