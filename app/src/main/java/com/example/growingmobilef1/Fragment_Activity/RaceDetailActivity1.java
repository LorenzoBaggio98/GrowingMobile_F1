...
public class RaceDetailActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView iw= (ImageView)findViewById(R.id.circuit_img1);
        try {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                Intent intent = new Intent(RaceDetailActivity1.this, MainActivity.class);
